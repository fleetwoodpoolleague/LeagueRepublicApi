...
[NuruRoute("ics", Description = "Generate an ics file for the given league.")]
public sealed class IcsCommand : ICommand<Unit>
{
    ...
    [Option("--league-name", "", Description = "League name to generate the ics file for. Required if league ID is not provided.")]
